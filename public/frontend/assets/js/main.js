...
window.onload = function () {
	...
	$(document).ready(function() {
		...
		****************************************************/
		tabBundle('#tab');
	  	...
	  	/****************************************************
					Countdown
		****************************************************/
		createCountDown('#event-countdown','2022/10/10');
		createCountDown('#event-countdown-2','2022/8/10');
		createCountDown('#event-countdown-3','2022/7/10');
		createCountDown('#event-countdown-4','2022/7/27');
		...
		****************************************************/
		...
		const searchFormInput = searchForm.querySelector("#search-txt"); // <=> document.querySelector("#search-form input");
		...
		if(SpeechRecognition) {
		  ...
		  searchForm.insertAdjacentHTML("beforeend", '<button type="button" class="btn-voice-search"><i class="fas fa-microphone"></i></button>');
