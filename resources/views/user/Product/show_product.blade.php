                  ...
                  <div class="price-filter_bottom">
                    <p>
                      ...
                      <div class="filter-group">
                        ...
                        <button class="normal-btn" id="sort-price"><i class="icon_search"></i></button>
                      </div>
                    </p>
                      ...
                      <div class="col-12 col-xl-8">
                        <div class="product-option">
                          <div class="product-filter">
                            <form>
                              {{csrf_field()}}
                              <select class="select-form" id="sort_by" name="sort_by">
                                <option value="{{Request::url()}}?sort_by=none" <?php if($sort=="none") echo 'selected'; ?> >--Chọn--</option>
                                <option value="{{Request::url()}}?sort_by=az" <?php if($sort=="az") echo 'selected'; ?> >A - Z</option>
                                <option value="{{Request::url()}}?sort_by=za" <?php if($sort=="za") echo 'selected'; ?> >Z - A</option>
                                <option value="{{Request::url()}}?sort_by=decrease" <?php if($sort=="decrease") echo 'selected'; ?> >Giá: Thấp đến Cao</option>
                                <option value="{{Request::url()}}?sort_by=increase" <?php if($sort=="increase") echo 'selected'; ?> >Giá: Cao đến Thấp</option>
                              </select>
                            </form>
                          </div>
