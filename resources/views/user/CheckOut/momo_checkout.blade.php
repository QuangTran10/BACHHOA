		...
		<div class="row">
			...
			<div class="col-12 col-lg-8">
				<form action="{{URL::to('/momo_payment')}}" method="post">	
					...
					<input type="hidden" name="PhuongThuc" id="paymethod" value="Thanh Toán Bằng MOMO">
					<div class="form-group">
					...
					<input type="submit" class="normal-btn" name="redirect" value="THANH TOÁN MOMO" <?php if($user_id==null) echo "disabled" ?>>
				</form>
			</div>
